...
export async function POST(request: NextRequest) {
    try {
        ...
        const emailResult = await sendMail({
            email,
            subject: "Welcome to EasyCom Newsletter! 🎉",
...
<head>
    ...
    <title>Welcome to EasyCom Newsletter</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="welcome-message">
                ...
                <p>
                    Thank you for subscribing to the EasyCom newsletter! We're thrilled to have you as part of our community. 
            ...
            <div class="cta-section">
                ...
                <a href="${process.env.NEXT_PUBLIC_BASE_URL || "https://sajidmahamud.vercel.app"
        }" class="cta-button">
                    Shop Now →
                </a>
            </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p><strong>EasyCom</strong></p>
            <p>Capstone project by Sajid Mahamud - <a href="https://sajidmahamud.vercel.app">Portfolio</a></p>
            <p>
                Questions? Contact the project admin at <a href="mailto:sajidmahamud835@gmail.com">sajidmahamud835@gmail.com</a>
            </p>
            
            <div class="social-links">
                <a href="https://sajidmahamud.vercel.app">Portfolio</a>
            </div> 
            
            <div class="unsubscribe">
                <p>
                    You received this email because you subscribed to the EasyCom Newsletter with ${email}.<br>
