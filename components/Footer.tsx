    ...
    <footer className="bg-white border-t">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-6 border-t text-center text-sm text-gray-600">
          <p>
            © {new Date().getFullYear()} EasyCom — Capstone project by <a href="https://sajidmahamud.vercel.app" className="text-shop_dark_green hover:underline">Sajid Mahamud</a>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
