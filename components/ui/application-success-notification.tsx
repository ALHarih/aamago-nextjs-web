...
export default function ApplicationSuccessNotification({
  ...
  const config = {
    premium: {
      ...
      subtitle: `Thanks ${userName}!`,
      description:
        "Your request has been submitted and will be reviewed. Planned features are under development and will be available when completed.",
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div
        className={`max-w-lg w-full bg-white rounded-2xl shadow-2xl border border-gray-200 transform transition-all duration-500 ${isAnimating ? "scale-100 opacity-100" : "scale-95 opacity-0"
          }`}
      >
        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>• Planned features will be scheduled for development and activated when completed</li>
            </ul>
          </div>
