...
```bash
NEXT_PUBLIC_COMPANY_NAME=EasyCom                          # Your project/company name (capstone)
NEXT_PUBLIC_COMPANY_EMAIL=your-email@example.com             # Main contact email
...
```bash
NEXT_PUBLIC_SUPPORT_EMAIL=your-email@example.com             # Customer support email
NEXT_PUBLIC_SALES_EMAIL=sales@easycom.com                 # Sales team email
```
...
```bash
NEXT_PUBLIC_FACEBOOK_URL=https://facebook.com/easycom
NEXT_PUBLIC_TWITTER_URL=https://twitter.com/easycom
NEXT_PUBLIC_INSTAGRAM_URL=https://instagram.com/easycom
NEXT_PUBLIC_LINKEDIN_URL=https://linkedin.com/company/easycom
```

### Legal Pages

```bash
NEXT_PUBLIC_COPYRIGHT_TEXT=© 2025 EasyCom. All rights reserved.
