...
Successfully implemented a comprehensive user profile system with address management and a reward/loyalty points system for the EasyCom capstone project.
