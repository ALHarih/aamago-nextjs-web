# SEO Implementation Guide - EasyCom

## Overview

This document outlines the SEO implementation for EasyCom. The implementation follows modern SEO best practices and is optimized for Next.js 16.
...
- Title template: `%s | EasyCom - Capstone E-Commerce Project`
...
**Example URL:** `https://example.com/product/iphone-15-pro`
...
**Example URL:** `https://example.com/category/electronics`
...
```json
{
  ...
  "sameAs": ["https://facebook.com/easycom", "https://twitter.com/easycom"]
}
```
