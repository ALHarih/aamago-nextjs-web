...
const transporter: Transporter<SMTPTransport.SentMessageInfo> =
    nodemailer.createTransport({
        ...
        auth: {
            type: "OAuth2",
            user: process.env.SENDER_EMAIL_ADDRESS || "sajidmahamud835@gmail.com",
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Thank you from EasyCom (Capstone project)</p>
        </div>
            ...
            <div class="support-section">
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        <strong>Email</strong>
                        <span>sajidmahamud835@gmail.com</span>
                    </div>
                    <div class="contact-item">
                        <strong>Phone</strong>
...
const sendOrderConfirmationEmail = async (
    ...
    try {
        ...
        const mailOptions = {
            from: `"EasyCom (Capstone Project)" <${process.env.SENDER_EMAIL_ADDRESS || "sajidmahamud835@gmail.com"
                }>`,
...
If you have any questions, please contact the project admin at sajidmahamud835@gmail.com.

Thank you from EasyCom (Capstone project)!
      `,
        };
